...
setup(name='newm-next',
      ...
      packages=['newm', 'newm.helper', 'newm.lang_layout','newm.power_manages', 'newm.resources', 'newm.overlay', 'newm.widget', 'newm.dbus', 'newm.gestures', 'newm.gestures.provider', 'newm_panel_basic'],
